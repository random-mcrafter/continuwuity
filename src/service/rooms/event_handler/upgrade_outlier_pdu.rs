use conduwuit::{debug, debug_info, debug_warn, err, error, implement, is_equal_to, matrix::{state_res, Event, EventTypeExt, PduEvent, StateKey}, trace, utils::{
	stream::{BroadbandExt, ReadyExt},
	IterStream,
}, warn, Err, Result};
use futures::{future::ready, FutureExt, StreamExt};
use ruma::{events::StateEventType, CanonicalJsonValue, OwnedEventId, RoomId, ServerName};
use std::collections::{HashMap, HashSet};
use std::{borrow::Borrow, collections::BTreeMap, sync::Arc, time::Instant};
use tokio::join;

use super::{build_local_dag, get_room_version_rules};
use crate::rooms::{
